        ...
        <div class="col-md-8 col-lg-8 pb-4">
          ...
          <form>
            <div class="row">
              <div class="col-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="fname" name="firstName" data-validation="required min max"
            ...
            <div class="form-group mb-5">
              ...
              <textarea name="message" class="form-control" id="message" cols="30" rows="5" data-validation="required"></textarea>
